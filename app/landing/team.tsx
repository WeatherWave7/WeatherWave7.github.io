...
export default function Team() {
  return (
    <div className="flex justify-center items-center min-h-0 bg-gray-100 py-0">
      <div className="px-4 py-4 mx-auto sm:max-w-screen md:max-w-screen lg:max-w-screen md:px-24 lg:px-8 lg:py-0" style={{ width: '740px', height: '300px' }} data-allytip="true">
