          ...
          <div className="max-w-2xl mx-auto sm:max-w-xl md:max-w-2xl">
            <div className="text-center">
              <div className="max-w-xl mb-0 md:mx-auto sm:text-center lg:max-w-2xl md:mb-3">
                ...
                Your Ultimate Companion for Weather Updates
                </h2>
              ...
              <p className="max-w-md mx-auto mb-4 mt-6 text-xs text-gray-600 sm:text-sm md:mb-2">
                Get the most precise and up-to-date weather information for
                your location. Stay prepared for any weather conditions with
                WeatherWave.
              </p>
            </div>
          </div>
